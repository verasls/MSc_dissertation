...
\noindent Veras, L. (2019). Are we getting the right accelerometer based measures from patientes with obesity? Establishing new equations based on raw data for ground reaction force and energy expenditure prediction. Dissertação de Mestrado apresentada à Faculdade de Desporto da Universidade do Porto.
